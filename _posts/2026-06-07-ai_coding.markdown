...
The harnesses will improve to iterate on a problem better, hit fewer cycles - even with the smaller models.
...
What worries me is maintaining it all in the long term.
...
While software is cheap to create now we have AI, it does not mean it is cheap to maintain in the future - especially if prices rise.
...
* Learning a new language or framework? Ask AI to create a project with a guide.
* Starting a new project? Ask the agent to create a skeleton.
* Need a quick script or *internal* tool? Put the agent in charge.
